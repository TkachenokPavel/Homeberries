import { createElement, calculateDicsount } from "../utils/helpers.js"
...
const createProductCard = (id, name, category, price, photo, discount) => {
	...
	const cardNewPrice = createElement("span", "card__price-new", `${calculateDicsount(price, discount) + " руб"}`);
